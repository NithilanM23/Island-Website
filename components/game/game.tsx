...
const HOUSES: CategoryMeta[] = [
  ...
  })).filter(c => c.id !== 'hero' && c.id !== 'contact')
]
...
const PATH_DECOR: PathDecor[] = [
  { type: 'bridgeSign', x: 22, y: 13, dirX: 0, dirY: -1, ids: ['experience'] }, // north bridge
  { type: 'bridgeSign', x: 22, y: 27, dirX: 0, dirY: 1, ids: ['skills'] }, // south bridge
  { type: 'bridgeSign', x: 31, y: 18, dirX: 1, dirY: 0, ids: ['projects'] }, // east bridge
  { type: 'bridgeSign', x: 17, y: 22, dirX: -1, dirY: 0, ids: ['research'] }, // west bridge
]
...
export function Game() {
  ...
  // Use portfolio section metadata instead of Shopify categories
  ...
  useEffect(() => {
    ...
    function step(t: number) {
      ...
      if (sceneRef.current === 'world') {
        ...
        // 2.0 tiles from the center of a 2x2 house allows interacting from any adjacent wall
        let best = 2.0
        for (const cat of HOUSES) {
  ...
  return (
    ...
    >
      ...
      {/* bottom-left: controls hint. Hidden on touch
